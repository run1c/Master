...
of the single point measurements and Table \ref{tab:dac_prec_result} holds the mininum, mean and maximum RMS as a result of the precision analysis.
	...
	\begin{figure}[t]
		\centering
			\includegraphics[width=0.6\textwidth]{Figures/weinstock/dac_cal_point.pdf}
	...
	\begin{figure}[t]
		\centering
			\includegraphics[width=1.\textwidth]{Figures/weinstock/dac_cal_B.pdf}
	...
	\begin{figure}[t]
		\centering
			\includegraphics[width=0.6\textwidth]{Figures/weinstock/dac_B_RMS.pdf}
