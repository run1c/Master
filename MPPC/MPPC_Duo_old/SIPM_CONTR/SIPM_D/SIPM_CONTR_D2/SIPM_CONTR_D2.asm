...
.db 0x01,0x39,0x00,0x04,0xF9,0xEA,0xFF,0xFF,0xFB,0x08,0x38,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sea1,Sea2,Sea3,Sea4,seb1,Seb2,Seb3,Seb4
.db 0xF4,0x36,0x1A,0x37,0x09,0x08,'1','2','6','2','1','2','6','4'

#elif Module2
;U11 = MAX4162 15,06,2012
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x02,0x39,0xff,0xff,0xFA,0xD8,0xff,0xf7,0xFA,0x80,0x61,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x00,0x37,0x1A,0x37,0x04,0x02,'1','2','6','6','1','2','7','0'

#elif Module3
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x03,0x39,0x00,0x00,0xFA,0x90,0xFF,0xFD,0xFA,0x40,0x82,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x0E,0x37,0x30,0x37,0x01,0x05,'1','2','6','5','1','2','6','7'

#elif Module4
;U11 = MAX4162 15,06,2012
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x04,0x39,0xff,0xf9,0xFA,0xa7,0xFF,0xFD,0xFA,0x8b,0x40,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xEE,0x36,0x12,0x37,0x10,0x07,'1','2','6','3','1','2','6','9'

#elif Module5
;U11 = MAX4162 15,06,2012
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x05,0x00,0x00,0x07,0xFA,0xF8,0xff,0xfD,0xFA,0x70,0x2E,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xB0,0x36,0xB0,0x36,0x01,0x02,'0','0','0','0','0','0','0','0'

#elif Module6
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x06,0x39,0xFF,0xFE,0xF9,0xE6,0x00,0x04,0xFB,0xA8,0x57,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x4A,0x36,0x46,0x36,0x01,0x02,'0','4','7','7','0','4','7','8'

#elif Module7
;U11 = MAX4162 15,06,2012
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x07,0x39,0x00,0x03,0xF9,0xC0,0x00,0x08,0xFA,0x30,0x4E,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x72,0x37,0x76,0x37,0x01,0x02,'0','3','5','2','0','3','5','1'
;S10362-33-100C; Sera 9J000352; Serb 9J000351

#elif Module8
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x08,0x39,0x00,0x05,0xFA,0x4F,0xff,0xf8,0xFA,0xE4,0x55,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xBC,0x37,0xAC,0x37,0x03,0x01,'1','1','7','8','1','1','7','6'

#elif Module9
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x09,0x39,0xFF,0xF8,0xFB,0xEF,0x00,0x0C,0xFA,0x91,0x7E,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xB8,0x37,0xB4,0x37,0x04,0x02,'1','1','7','9','1','1','7','7'

#elif ModuleA
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x0A,0x00,0x02,0xBc,0xEF,0x2B,0x02,0xc0,0xEE,0x6C,0x64,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xAC,0x0D,0xAC,0x0D,0x01,0x02,'0','0','0','0','0','0','0','0'

#elif ModuleB
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x0B,0x00,0x02,0xBC,0xEF,0x90,0x02,0xB5,0xEE,0xB0,0x43,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xAC,0x0D,0xAC,0x0D,0x01,0x02,'0','0','0','0','0','0','0','0'

#elif ModuleC
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x0C,0x00,0x02,0xBB,0xEF,0x38,0x02,0xBD,0xEF,0x30,0x87,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xAC,0x0D,0xAC,0x0D,0x01,0x02,'0','0','0','0','0','0','0','0'

#elif ModuleD
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x0D,0x00,0x02,0xBC,0xF9,0xD8,0x00,0x01,0xFB,0xA0,0x57,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xAC,0x0D,0xAC,0x0D,0x01,0x02,'0','0','0','0','0','0','0','0'
...
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x0F,0x39,0x00,0x00,0xF9,0xD8,0x00,0x04,0xFB,0xA7,0x8f,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x00,0x00,0x2C,0x37,0x00,0x00,'0','0','0','0','0','0','1','8'

#elif Module1A ; 1A channel auger
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x1A,0x39,0x00,0x00,0xF9,0xD8,0x00,0x04,0xFB,0xA7,0x8f,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x00,0x00,0x2C,0x37,0x00,0x00,'0','0','0','0','0','0','1','8'
...
; 4 channel auger
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
;.db 0x0a,0x39,0x00,0x00,0xF9,0xD8,0x00,0x04,0xFB,0xA7,0x8f,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
;.db 0x00,0x00,0x2C,0x37,0x00,0x00,'0','0','0','0','0','0','1','8'
...
#elif Module10
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x10,0x39,0x00,0x00,0xFB,0x4f,0xFF,0xFA,0xFA,0x40,0x6A,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x48,0x39,0x4A,0x39,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module11
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x11,0x39,0x00,0x02,0xFA,0x05,0xFF,0xFA,0xF9,0x7B,0x6E,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x50,0x39,0x52,0x39,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module12
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x12,0x39,0xFF,0xF5,0xFA,0x6d,0xFF,0xFD,0xFA,0x7d,0x4C,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x4E,0x39,0x4C,0x39,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module13
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x13,0x39,0xFF,0xFA,0xFA,0x80,0x00,0x02,0xFB,0xC4,0x92,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0x56,0x39,0x54,0x39,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module14
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x14,0x00,0x00,0x05,0xFA,0xD8,0xFF,0xFB,0xFA,0xA8,0x4A,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xA0,0x0F,0xA0,0x0F,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module15
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x15,0x00,0xFF,0xF8,0xFB,0x3F,0x00,0x03,0xFB,0x38,0x16,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xA0,0x0F,0xA0,0x0F,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module16
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x16,0x00,0x00,0x09,0xFB,0x0A,0xFF,0xFC,0xF9,0xA0,0x3D,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xA0,0x0F,0xA0,0x0F,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module17
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x17,0x00,0xFF,0xF9,0xFA,0x70,0xFF,0xFD,0xFA,0xB4,0x32,0x01,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xA0,0x0F,0xA0,0x0F,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module18	;lotze
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x18,0x00,0x00,0x01,0xFA,0xB0,0xFF,0xFA,0xFB,0xD0,0x54,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xA0,0x0F,0xA0,0x0F,0x00,0x00,'0','0','0','0','0','0','0','0'

#elif Module19	;lotze
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0x19,0x00,0x00,0x00,0xFA,0x94,0x00,0x06,0xFA,0xDA,0x7C,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xA0,0x0F,0xA0,0x0F,0x00,0x00,'0','0','0','0','0','0','0','0'
...
;#elif ModuleFF
;  ow_ad,Vcoi,VaoH,VaoL VagH,VagL,VboH,VboL,VbgH,VbgL,Tho,ThgH,ZhgL
.db 0xff,0x00,0x00,0x00,0xF9,0xD8,0x00,0x01,0xFB,0xA0,0x57,0x00,0x00
;   VaL, VaH, VbL, VbH, Sano,Sbno,Sera1,Sera2,Sera3,Sera4,serb1,Serb2,Serb3,Serb4
.db 0xAC,0x0D,0xAC,0x0D,0x00,0x00,'0','0','0','0','0','0','0','0'
#endif
...
GET_V20B:							
		...
		clr		count
		ldi		tmp,0x04
		sts		max_val,tmp 				;first nibble maxvalue +1
		ldi		YL,low(scratch_RAM)
		ldi		YH,high(scratch_RAM)
		sbr		flags,(1<<echo_f)
		rjmp	MAIN_M				
...
READ_TST:	; send test
		rcall	OUTCH						; ECHO
		lds		temp,V_com_fact_H	
		rcall	OUTH
		lds		temp,V_com_fact_L	
		rcall	OUTH
		ldi		comun_flags,0x03
		rjmp	MAIN_M
...
temp_comp:
		...
		sub		BL,AL;0xF9;250	;25,0 grad C 0.1 grad/count
		sbc		BH,AH
		lds		AL,V_coif_ad 
		clr		AH
		rcall	mul16x16_16
		...
		ldi		AH,0x05	;0x19			;divide by 10 (0.1 deg temperature resulution)
		ldi		AL,0x1F	;0x9B;B;A
		rcall	muls16x16_32
...
.dw	NO_COMA,NO_COMA,NO_COMA,READ_SENSOR_DATA,READ_TST,NO_COMA,NO_COMA,NO_COMA,NO_COMA,NO_COMA,NO_COMA,NO_COMA,NO_COMA,NO_COMA,NO_COMA,NO_COMA
...
HELP_TX:
	.db 10,13
	.db "HW Version x.x  SW Version 1.1"
	.db 10,13
	.db "Commands: "
	.db 10,13
	.db "'<' Start Delimiter "
	...
	.db "'>' Stop Delimiter"
	.db 10,13
	.db "'A' Set Bias Voltage Sensor A 5mV/count 0x0000...0x3fff "
	.db 10,13
	.db "'B' Set Bias Voltage Sensor B 5mV/count 0x0000...0x3fff "
	.db 10,13.
    .db "'C' Set Bias Voltage Progression Coefficient 00...5F (mV/K) "
	.db 10,13
